...
final class HabitsViewController: UIViewController {
    ...
    lazy var habitsCollectionView: UICollectionView = {
        ...
        collectionView.backgroundColor = .MyHabitsColor.whiteBackgroundColor
    ...
    private lazy var addButton: UIButton = {
        ...
        button.imageView?.tintColor = UIColor.MyHabitsColor.purpleColor
    ...
    private func setupUI() {
        ...
        view.addSubviews(habitsCollectionView, todayLabel, addButton)
        habitsCollectionView.backgroundColor = .MyHabitsColor.whiteColor
...
extension HabitsViewController: UpdateCollectionViewProtocol {
    func reloadSlider() {
        habitsCollectionView.reloadData()
    }
}
